...
Подробное описание слоёв и моделей находится в [документации DWH](docs/dwh/README.md). Результат визуализации представлен в [описании дашборда Metabase](docs/metabase/README.md). Исходное условие доступно в [описании тестового задания](docs/test-task-description.pdf).
